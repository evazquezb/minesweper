...
try {
    ...
    const level1 = {
        level: "principiante", rows: 8, columns: 8, eggs: 10, cellsToClear: 54, cellsCleared: 0, flagged: 0,
        win: false, lose: false, animating: false, playing: false, eggsToExplote: 10, eggsChecked: 0, eggsExploted: 0
    }
    const level2 = {
        level: "intermedio", rows: 16, columns: 10, eggs: 32, cellsToClear: 128, cellsCleared: 0, flagged: 0,
        win: false, lose: false, animating: false, playing: false, eggsToExplote: 32, eggsChecked: 0, eggsExploted: 0
    }
    const level3 = {
        level: "avanzado", rows: 16, columns: 12, eggs: 50, cellsToClear: 192, cellsCleared: 0, flagged: 0,
